...
<centeR><form action="searchevents1.jsp">
<table style="font-family:Bradley Hand ITC;font-size:22px;font-weight:bold;font-size:26px;">
<tr><th style="color:white;">Enter City:</th><th><input type="texT" name="location" placeholder="enter city name" required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black" /></th></tr>
<tr><th colspan=2><input type="submit" value="submit" style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:40%;border-radius: 19px;color:white;"/></th></tr>
</form>
</table>
		<br><br><a href="orgHome.jsp">Back</a>										
                                            </div>
                                        </div>
                                    </div>
                                </div>
