...
<h3 style="font-family:Bradley Hand ITC;font-size:40px;font-weight:bold;">Welcome to Organizer,<%= session.getAttribute("ONAME") %></h3>
<form action="createevent.jsp" method="POST" class="orgform">
  <table style="font-family:Bradley Hand ITC;font-size:22px;font-weight:bold;font-size:22px;" align="center">
      
          <tr>
              <th style="color:white;">EventName:</td>
              <th><input type="text" name="eventname" placeholder="enter Event Name" required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"></td>
          </tr>
          <tr>
              <th style="color:white;">EventDate:</td>
              <th><input type="date" name="eventdate" placeholder="YYYY-MM-DD" required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"></td>
          </tr>
          <tr>
              <th style="color:white;">EventCategory:</td>
              <th><select name="eventcategory" required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black">
                <option  value="food">Food</option>
                <option  value="cultural">Cultural</option>
                <option  value="college">CollegeFest</option>
                <option  value="social">Social</option>
            </select></td>
          </tr>
          <tr>
              <th style="color:white;">EventTicketPrice:</td>
              <th><input type="number" name="eventticketprice" placeholder="enter Ticket Price" required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"></td>
          </tr>
          <tr>
              <th style="color:white;">EventVenue:</td>
              <th><input type="text" name="eventvenue" placeholder="enter Event venue" required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"></td>
          </tr>
          <tr>
              <th style="color:white;">EventArea:</td>
              <th><input type="text" name="eventarea" placeholder="enter Event Area" required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"></td>
          </tr>
		  <tr>
              <th style="color:white;">EventCity:</td>
              <th><input type="text" name="eventcity" placeholder="enter Event City" required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"></td>
          </tr>
          <tr>
              <th><input type="submit" name="submit" value="CREATE EVENT" style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:100%;border-radius: 19px;color:white;"></td>
              <th><input type="reset" name="reset" value="RESET" style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:40%;border-radius: 19px;color:white;"></td>
          </tr>
          
      
  </table>
  <br><a href="orgHome.jsp">Back</a>
</form>
