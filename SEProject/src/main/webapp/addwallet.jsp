...
<form action="addwallet1.jsp" method="post">
<table align="center" style="font-family:Bradley Hand ITC;font-size:22px;font-weight:bold;font-size=20px;">
<tr><th style="color:white;">Enter Amount:</th><th><input type="number" name="bal" placeholder ="Enter amount"style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"/></th></tr>
