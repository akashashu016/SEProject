...
<form >
 <input type="button" value="Add Balance" onclick="window.location='addwallet.jsp' " style="font-family:Bradley Hand ITC;font-size:30px;font-weight:bold;background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:20%;border-radius: 19px;color:white;"/>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <input type="button" value="View Balance" onClick="window.location='viewwallet.jsp' " style="font-family:Bradley Hand ITC;font-size:30px;font-weight:bold;background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:20%;border-radius: 19px;color:white;"/>
</form>
<br><br>
