...
<table align="center">
<tr><th><button style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:100%;border-radius: 19px;"><a href="addevents.jsp" style="font-family:Bradley Hand ITC;font-size:25px;font-weight:bold;color:white;">Add Events</a></button></th></tr>
<tr><th><button style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:100%;border-radius: 19px;"><a href="searchevents.jsp" style="font-family:Bradley Hand ITC;font-size:25px;font-weight:bold;color:white;">Search Events</a></button></th></tr>
<tr><th><button style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:100%;border-radius: 19px;"><a href="oviewwallet.jsp" style="font-family:Bradley Hand ITC;font-size:25px;font-weight:bold;color:white;">View Wallet</a></button></th></tr>
