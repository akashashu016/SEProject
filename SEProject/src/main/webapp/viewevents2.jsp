...
<th style="color:white"><main style="font-size:30px;font-weight:bold;"><%= rs.getString(2) %></main><br><%= rs.getString(3) %><br><%= rs.getString(5) %><br><%= rs.getString(6) %>,<%= rs.getString(8) %>,<%= rs.getString(9)%><br><button style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:50%;border-radius: 19px;"><a href="admindeleteevents.jsp?eid=<%= eid %>" style="color:white;" >Delete</a></button></th>
	</tr>
	<%
 }
%>
...
<bR><br><a href="adminviewevents.jsp">Back</a>												
                                            </div>
                                        </div>
                                    </div>
                                </div>
