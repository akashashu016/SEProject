...
<h3 style="font-family:Bradley Hand ITC;font-size:40px;font-weight:bold;">Welcome to Organizer,<%= session.getAttribute("ONAME") %></h3>
			  ...
			  <table align="center" width=70% height=50% border=3>
			  
			  <%
			  String pid=request.getParameter("eid");
			   %>
				<table  align="center" style="font-size:20px;">		 
<form action="uploadFile1.jsp?id=<%= pid %>" method="post" name="upform"  enctype="multipart/form-data">
<tr><th>    <font face="Bradley Hand ITC" size="10" color="#0CBEAC">Upload Image</font></b></th></tr>
                        <tr>  
                            <td align="left"><font face="Bradley Hand ITC" color="#E4DB6B" size="5"><b>Select a file to upload :</b></font></td>  
                        </tr>  
                        <tr>  
                            <td align="left">  
                        ...
                        <tr>  
                            <td align="left">  
                                <input type="submit" name="Submit" value="Upload" style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:50%;border-radius: 19px;color:white;">
                                <input type="reset" name="Reset" value="Cancel" style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:50%;border-radius: 19px;color:white;">  
                            </td>  
                        </tr>  
</form>
                    </table>
