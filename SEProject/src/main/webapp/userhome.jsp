...
<table align="center">
<tr><th><button style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:100%;border-radius: 19px;"><a href="searcheventsu.jsp" style="font-family:Bradley Hand ITC;font-size:25px;font-weight:bold;color:white;">Search Events</a></button></th></tr>
<tr><th><button style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:100%;border-radius: 19px;"><a href="viewevents.jsp" style="font-family:Bradley Hand ITC;font-size:25px;font-weight:bold;color:white">View Events</a></button></th></tr>
<tr><th><button style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:100%;border-radius: 19px;"><a href="viewbookings.jsp" style="font-family:Bradley Hand ITC;font-size:25px;font-weight:bold;color:white">View Bookings</a></button></th></tr>
<tr><th><button style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:100%;border-radius: 19px;"><a href="wallet.jsp" style="font-family:Bradley Hand ITC;font-size:25px;font-weight:bold;color:white">Wallet</a></button></th></tr>
<tr><th><button style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:100%;border-radius: 19px;"><a href="index.html" style="font-family:Bradley Hand ITC;font-size:25px;font-weight:bold;color:white">LogOut</a></button></th></tr>
</table>
