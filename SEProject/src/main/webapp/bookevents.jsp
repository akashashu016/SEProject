...
<h3 style="font-family:Bradley Hand ITC;font-size:40px;font-weight:bold;">Welcome to User,<%= session.getAttribute("UserName") %></h3>
<%@page import="java.sql.*" %>
<form action="bookevents1.jsp" method="post">
<table align="centeR" style="font-family:Bradley Hand ITC;font-size:22px;font-weight:bold;font-size=20px;">
<tr><td align="center" colspan=2 style="font-family:Bradley Hand ITC;font-size:29px;font-weight:bold;color:white">Book Event</td></tr>
<%
int eid=Integer.parseInt(request.getParameter("eid"));
Class.forName("com.mysql.jdbc.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:8083/evento","root","password");
PreparedStatement pst=con.prepareStatement("select * from event_details where eid=?");
pst.setInt(1,eid);
ResultSet rs=pst.executeQuery();
if(rs.next())
{
%>
<tr><th style="color:white;">EventId:</th><th><input type="text" name="eid" value=<%= rs.getInt(1) %> required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"/></th> </tr>
<tr><th style="color:white;">EventName:</th><th><input type="text" name="ename" value=<%= rs.getString(2) %> required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"/></th> </tr>
<tr><th style="color:white;">Date:</th><th><input type="text" name="edate" value=<%= rs.getString(3) %> required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"/></th> </tr>
<tr><th style="color:white;">Category:</th><th><input type="text" name="ecate" value=<%= rs.getString(4) %> required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"/></th> </tr>
<tr><th style="color:white;">Price:</th><th><input type="number" name="eprice" value=<%= rs.getInt(5) %> required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"/></th> </tr>
<tr><th style="color:white;">Venue:</th><th><input type="text" name="evenue" value=<%= rs.getString(6) %>,<%= rs.getString(8) %>,<%= rs.getString(9)%>required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"/></th> </tr>

<tr><th style="color:white;">Number Of Tickets:</th><th><input type="number" name="etickets" required style="width: 100%;padding: 4px 12px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;box-sizing: border-box;border-radius:10px;color:black"/></th> </tr>
<tr>

<th style="color:white;"><input type="submit" value="submit" style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:100%;border-radius: 19px;color:white;"/></th>
<th style="color:white;"><input type="reset" value="reset" style="background-color: #008080;padding: 2px 8px;margin: 8px 0;border: none;cursor: pointer;width:50%;border-radius: 19px;color:white;"/></th>
</tr>
