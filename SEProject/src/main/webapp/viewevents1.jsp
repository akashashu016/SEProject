...
String cate=request.getParameter("cate");
 ...
 PreparedStatement pst=con.prepareStatement("select * from event_details where ecategory=?");
...
%><tr>
	<th><img src="images/<%= fpath %>" width="400" height="" style="border-radius:20px;" /></th>
...
<br><a href="viewevents.jsp">Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
