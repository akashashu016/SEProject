...
<table align="center" style="font-family:Bradley Hand ITC;font-size:30px;font-weight:bold;" border=0>
<%
...
PreparedStatement pst=con.prepareStatement("select * from owallet where username=?");
pst.setString(1,user);
ResultSet rs=pst.executeQuery();
rs.next();
%>
<tr><th style="color:white">Wallet Balance</th><th style="color:white"><%= rs.getString(3) %></tH></tr>
</table>
					<br>
